                ...
                <div className="content-left">
                    ...
                    <div className="img-down">
                        <div className='img-small'>
                            <img src={snicker1} alt="product-up" onClick={() => setCurrentUpImg(snicker1)} className={currentUpImg === snicker1 ? "active" : ""} />
                        </div>
                        <div className='img-small'>
                            <img src={snicker2} alt="product-up" onClick={() => setCurrentUpImg(snicker2)} className={currentUpImg === snicker2 ? "active" : ""} />
                        </div>
                        <div className='img-small'>
                            <img src={snicker3} alt="product-up" onClick={() => setCurrentUpImg(snicker3)} className={currentUpImg === snicker3 ? "active" : ""} />
                        </div>
                        <div className='img-small'>
                            <img src={snicker4} alt="product-up" onClick={() => setCurrentUpImg(snicker4)} className={currentUpImg === snicker4 ? "active" : ""} />
                        </div>
                    </div>
                </div>
